...
exports.build = function (opts) {
  ...
  var customPath = path.resolve(process.cwd(), opts.config || config.config)
  var varsContent = fs.readFileSync(customPath, 'utf8') + fs.readFileSync(varsPath, 'utf8')
