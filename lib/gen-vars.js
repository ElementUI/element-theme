...
var filePath = path.resolve(process.cwd(), config.variable)
...
exports.init = function (_file) {
  ...
  filePath = path.resolve(process.cwd(), _file ? _file : config.variable)
...
exports.replace = function () {
  if (!fs.existsSync(filePath)) {
    ora('Not found variables file, please run "et -i"').fail()
    process.exit(1)
  }
